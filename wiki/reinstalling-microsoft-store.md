...
The Microsoft Store is used to download applications. But it may sometimes glitch out and disappear. This article will cover the steps of reinstalling it.
...
> The WSReset function is outdated and may not function correctly. If Method 1 of resetting the Microsoft Store cache doesn't work, try reinstalling the Microsoft Store. This method is still available.
...
After that, you want to restart your computer to apply changes that were made and your the Microsoft Store should be working again.