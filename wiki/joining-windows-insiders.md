...
> You must be logged onto a Microsoft Account to be able to join the Windows Insider program. This guide is dedicated to Windows 10 only.
...
> If the registry does not exists, right click the key *UI* on the side bar and press *New > Key* and name it `Visibility`.
