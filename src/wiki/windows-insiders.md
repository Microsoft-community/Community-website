...
![Settings](./img/windows-insider/11/settings-home.png)

2. Click on **Windows Insider Program**, then navigate to the sign up page.

![Windows Insider Program page](./img/windows-insider/11/settings-select.png)

3. Click on the **Get Started** button to join the Windows Insider Program.

![Get Started](./img/windows-insider/11/get-started.png)

4. Click on **Link an account** to link a Microsoft Account.

![Link an account](./img/windows-insider/11/link-an-account.png)
...
![Agreements](./img/windows-insider/11/agreements.png)
...
![Channels](./img/windows-insider/11/channels.png)
...
![Reboot](./img/windows-insider/11/restart.png)
...
![Settings](./img/windows-insider/10/settings-home.png)

2. Click on **Windows Insider Program** on the sidebar to navigate to the sign up page.

![Select menu](./img/windows-insider/10/settings-select-side.png)

3. Click on the **Get Started** button to join the Windows Insider Program.

![Get Started](./img/windows-insider/10/get-started.png)

4. Click on **Register** to join the Windows Insider Program.

![Register](./img/windows-insider/10/register.png)

5. You will be prompted with a pop-up as shown below, click on **Sign Up**.

![Join the program](./img/windows-insider/10/signup.png)
...
![Agree & submit](./img/windows-insider/10/agree-and-submit.png)
...
![Link an account](./img/windows-insider/10/link-an-account.png)
...
![Channels](./img/windows-insider/10/channels.png)
...
![Reboot](./img/windows-insider/10/restart.png)
...
![Insider Program](./img/windows-insider/11/settings-select.png)

3. Click on **Stop getting preview builds**.

![Leaving](./img/windows-insider/11/leaving-get-started.png)

4. Click on **Leaving the Insider Program**.

![Unenroll](./img/windows-insider/11/unenroll-immediately.png)
...
![Stop receiving builds](./img/windows-insider/10/stop-receiving-builds.png)
...
![Select](./img/windows-insider/10/settings-select-side.png)

3. Click on **Leave the Insider Program**.

![Leaving](./img/windows-insider/10/leaving-get-started.png)
...
![Optional Diagnostic Data](./img/windows-insider/optional-diagnos.png)
...
![Select Optional](./img/windows-insider/optional-diagnos-select.png)
...
![Run](./img/windows-insider/run.png)
...
![Registry](./img/windows-insider/registry-1.png)
...
![Registry 2](./img/windows-insider/registry-2.png)
