...
Cliptok may share parts of the content of some messages with external services to check the messages against moderation filters. If the content of a message contains a URL, Cliptok will send the domain name from each URL to the Anti-Fish API at https://anti-fish.bitflow.dev/. The full content of messages is never sent by Cliptok to any third-party service.
...
Data stored by Cliptok is stored by Hetzner in Ashburn, Virginia. This data may additionally be stored in backups for a limited amount of time. Debug logs generated by Cliptok are stored by OVH in London, UK.
...
Data stored by Solaris is stored by Hetzner in Ashburn, Virginia. This data may additionally be stored in backups for a limited amount of time.
